...
import { ISetDocAction, ISDBDocChangedAction } from '../actions/sharedb_actions';

export interface ISDBDocsState {
    problems: SDBDoc<IPuzzleSet>|null,
...
export const shareDBDocs = (state: ISDBDocsState={problems: null, solutions: null, users: null, aggregateData: null, updateCount: 1}, action: ISetDocAction | ISDBDocChangedAction) => {
    const { type } = action;
